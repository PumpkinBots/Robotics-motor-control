 ...
 *
 *   frc::InvertingDifferentialDrive m_drive{m_left, m_right};
 * };
 * @endcode
 *
 ...
 * with SetDeadband().
 */
class InvertingDifferentialDrive : public frc::RobotDriveBase,
                          public wpi::Sendable,
                          public wpi::SendableHelper<InvertingDifferentialDrive> {
 public:
  /**
  ...
  /**
   * Construct a InvertingDifferentialDrive.
   *
   * To pass multiple motors per side, use a MotorControllerGroup. If a motor
   * needs to be inverted, do so before passing it in.
   */
  InvertingDifferentialDrive(frc::SpeedController& leftMotor, frc::SpeedController& rightMotor);

  ~InvertingDifferentialDrive() override = default;

  InvertingDifferentialDrive(InvertingDifferentialDrive&&) = default;
  InvertingDifferentialDrive& operator=(InvertingDifferentialDrive&&) = default;
